...
internal enum Asset {
  ...
  internal static let mainPink = ColorAsset(name: "main-pink")
  ...
  internal static let homeFastetServer = ImageAsset(name: "home-fastet-server")
  ...
  internal static let serversCheckCircleFilled = ImageAsset(name: "servers-check-circle-filled")
  internal static let serversCheckCircle = ImageAsset(name: "servers-check-circle")
  internal static let serversGoodSignal = ImageAsset(name: "servers-good-signal")
  internal static let chevronRight = ImageAsset(name: "chevron-right")
  internal static let settingTerms = ImageAsset(name: "setting-terms")
  internal static let settingsChangePasscode = ImageAsset(name: "settings-change-passcode")
  internal static let settingsContact = ImageAsset(name: "settings-contact")
  internal static let settingsFaceId = ImageAsset(name: "settings-faceId")
  internal static let settingsPaywallDizzy = ImageAsset(name: "settings-paywall-dizzy")
  internal static let settingsPolicy = ImageAsset(name: "settings-policy")
  ...
  internal static let tabUnselectHome = ImageAsset(name: "tab-unselect-home")
  internal static let tabUnselectSettings = ImageAsset(name: "tab-unselect-settings")
}
